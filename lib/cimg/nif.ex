defmodule CImg.NIF do
  ...
  def cimg_load_from_memory(_b),
    do: raise("NIF cimg_load_from_memory/1 not implemented")
  def cimg_resize(_c, _x, _y),
    do: raise("NIF cimg_resize/3 not implemented")
  def cimg_get_resize(_c, _x, _y, _a, _v),
    do: raise("NIF cimg_packed/5 not implemented")
  def cimg_mirror(_c, _axis),
    do: raise("NIF cimg_mirror/2 not implemented")
  def cimg_transpose(_c),
    do: raise("NIF cimg_transpose/1 not implemented")
  ...
  def cimg_display(_c, _disp),
    do: raise("NIF cimg_display/2 not implemented")
  def cimg_set(_val, _c, _x, _y, _z, _s),
  ...
  def cimg_draw_rect(_c, _x0, _y0, _x1, _y1, _color, _opacity, _pattern),
    do: raise("NIF cimg_draw_rect/8 not implemented")
  def cimg_draw_ratio_rect(_c, _x0, _y0, _x1, _y1, _color, _opacity, _pattern),
    do: raise("NIF cimg_draw_ratio_rect/8 not implemented")
  def cimg_draw_rect(_c, _x0, _y0, _x1, _y1, _color, _opacity),
    do: raise("NIF cimg_draw_rect/7 not implemented")
  def cimg_draw_triangle(_c, _x0, _y0, _x1, _y1, _x2, _y2, _color, _opacity, _pattern),
    do: raise("NIF cimg_draw_triangle/10 not implemented")
  def cimg_draw_triangle(_c, _x0, _y0, _x1, _y1, _x2, _y2, _color, _opacity),
    do: raise("NIF cimg_draw_triangle/9 not implemented")
  def cimg_shape(_c),
    do: raise("NIF cimg_shape/1 not implemented")
  def cimg_size(_c),
    do: raise("NIF cimg_size/1 not implemented")
  def cimg_transfer(_c, _c_src, _mapping, _cx, _cy, _cz),
  ...
  def cimgdisplay_u8(_c, _title, _normalization, _is_fullscreen, _is_close),
